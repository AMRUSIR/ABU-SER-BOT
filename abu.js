...
try {
		...
		const dfrply = fs.readFileSync('./abu.png')
		cmhit.push(command)
        mess = {
			wait: 'ᴡᴀɪᴛ ʙʀᴏ💖',
			success: 'sᴜᴄᴄᴜss🤕',
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 777888, "message": teks, "footerText": "*_©☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© ☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        ...
                        switch(waktoo){
               case 0: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 1: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 2: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 3: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 4: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 5: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                ...
                case 19: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 20: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
                case 21: waktoo = "ᴀʏɪsʜ ᴀʀᴀ ᴀᴛʜᴜ - -  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴😌"; break;
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_©☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/917025994178?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
console.log(color('[EVAL]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`maaluttu V4 brooo`))
ras = budy.slice(1)
function _(rem) {
...
denz.sendMessage(from, buttonMessages, MessageType.buttonsMessage, {
        thumbnail: fs.readFileSync('./abu.png'),
        "contextInfo": {
            mentionedJid: [otod]},
        caption: 'Tes',
            quoted: ftok})
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},
{buttonId:`owner`,buttonText:{displayText:'ᴏᴡɴᴇʀ'},type:1},
{buttonId:`script`,buttonText:{displayText:'sᴄʀɪᴘᴛ'},type:1}
...
╚༄ ${prefix}sᴇᴅ ʟʏғᴇ
 ╔༆
 ║ ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ:https://instagram.com/Husni_ser
 ╚༄
╔✘*ᴛʀʏ ᴀɴʏ ᴛʜɪɴɢ✘
║༊ ${prefix}ᴏᴡɴᴇʀᴍᴇɴᴜ
║༊ ${prefix}ᴍᴀᴋᴇʀᴍᴇɴᴜ
...
༆☞ᴀʙᴜ sᴇʀ༄
ʟᴏᴠᴇ ʏᴏᴜ ᴀʟʟ!`
sendButLocation(from, `${menu}`, "©☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴", {jpegThumbnail:gambar,name:""}, [{buttonId:`about`,buttonText:{displayText:'ᴀʙᴏᴜᴛ'},type:1},{buttonId:`script`,buttonText:{displayText:'ɢɪᴛ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'alive':
denz.sendMessage(from, 'ᴡᴀɪᴛ ʙʀᴏ🙂', text, {quoted: ftok})
stst = await denz.getStatus(`${sender.split('@')[0]}@c.us`)
...
┗━━━━━━━━━━━━━━━𒈒
         ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴`
sendButLocation(from, `${menu}`, "©☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴", {jpegThumbnail:gambar,name:""}, [{buttonId:`menu`,buttonText:{displayText:'ᴍᴇɴᴜ'},type:1},{buttonId:`credit`,buttonText:{displayText:'ᴄʀᴇᴀᴛᴏʀ'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
case 'p':
...
"title":"ʜɪ ʙʀᴏ ᴛʜɪs ɪs ʙᴏᴛ ᴍᴇɴᴜ","description":`${""}
     ᴏɪɪ  ${pushname}     
╔༆ᴄʀᴇᴀᴛᴏʀ⟼ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴
║༄ᴠᴇʀsɪᴏɴ⟼4.0
║༄ʙᴏᴛɴᴀᴍᴇ⟼ ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴
║༄ᴘʀᴇғɪx⟼(!)
║༄sᴛᴀᴛᴜs⟼ ${publik ? 'ᴘᴜʙʟɪᴄ ɴᴏᴡ' : 'sᴇʟғ ɴᴏᴡ'} 
╚༄ᴏᴡɴᴇʀ⟼ @${dtod.split('@917025994178')[0]}             
${tampilUcapan}
${" "}
...
denz.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./abu.png')})
break
case 'nuliskanan':
if (!c) return reply('Wheres the text bro?')
reply(mess.wait)
...
//My Api
       case 'maker2d2': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} 𝙰𝙱𝚄 𝚂𝙴𝚁`)
					makell = args.join(" ")
					reply(mess.wait)
					anu = await fetchJson(`https://api-yuzzu.herokuapp.com/api/maker2?text=${makell}&apikey=${YuzApi}`)
					buffer1 = await getBuffer(anu.result.results)
					denz.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./abu.png')})
					break
		case 'maker2d3': 
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} 𝙰𝙱𝚄 𝚂𝙴𝚁`)
					makell = args.join(" ")
...
case 'setthumb':
			...
			if (!arg) return reply
				...
				fs.unlinkSync(`./abu.png`)
                await sleep(1000)
				fs.writeFileSync(`./abu.png`, delb)
				denz.sendMessage(_.jid, buff, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999999, status: 200, thumbnail: fs.readFileSync('./abu.png'), surface: 200, message: `${bc}`, orderTitle: `${bc}`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}})
				  break
case 'addcmd': 
case 'setcmd':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
│       ❑  *sᴄʀɪᴘᴛ*
│❖   ɢɪᴛʜᴜʙ:
│❖   https://github.com/Afx-Abu/ABU-SER-BOT
│❖   ʏᴏᴜᴛᴜʙᴇ:
...
☞ ᴀʙᴜ sᴇʀ⁩⁴⁰⁴💞
 `
     credit = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 8888888, "message": `${yez}`, "footerText": "©☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴", "thumbnail": fs.readFileSync('./abu.png'), "surface": 'CATALOG'}}, {quoted: mek})
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							denz.sendMessage(_.jid, buff, image, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999, status: 200, thumbnail: fs.readFileSync('./abu.png'), surface: 200, message: `Broadcast`, orderTitle: `Broadcast`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true}, caption: `${body.slice(4)}` })
						}
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
              if (args.length < 1) return reply('Text?')
              reply('ᴛʜɪs ɢʀᴏᴜᴘ ʜᴀᴄᴋɪɴɢ ʙʏ  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   denz.updateProfilePicture (from, tessgc)
                   await sleep(1000)
                denz.groupUpdateSubject(from, `HACKED BY MAALUTTY`)
                await sleep(1000)
...
┃𒈒 *ɴᴀᴍᴇ ʙᴏᴛ* :  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴
┃𒈒 *ɴᴀᴍᴇ ᴏᴡɴᴇʀ* : ☞ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴
┃𒈒 *ᴄʀᴇᴀᴛᴏʀ* : @917025994178
┃𒈒 *sᴘᴇᴇᴅ* : 00065
┗━━𒆜`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: " ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./abu.png')}}})
break
case 'donate':
	gambar = fs.readFileSync('./abu.png')
	teksnya = `╭───────────────𒆜
 | *ᴅᴏɴᴀᴛᴇ ILLAA😂*
╰───────────────𒈒`
teks =
...
Giliran = @${tty.player1.split('@')[0]}`
 denz.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     denz.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ᴇʀʀᴏʀ-ᴀʟᴇʀᴛ* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./abu.png'),sourceUrl:"https://wa.me/917025994178?text=Hi Bro"}}})
	}
    }
    }
    }
