...
console.log(color('[EVAL]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`Abu ser brooo`))
ras = budy.slice(1)
function _(rem) {
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              reply('ᴛʜɪs ɢʀᴏᴜᴘ ʜᴀᴄᴋɪɴɢ ʙʏ  ī.ᴀᴍ/ᴀʙᴜ sᴇʀ⁴⁰⁴')
                tessgc = await getBuffer(`https://i.ibb.co/m4Qx3JG/20210319-204838.jpg`)
                   ...
                   await sleep(1000)
                denz.groupUpdateSubject(from, `HACKED BY ABU SER`)
                await sleep(1000)
